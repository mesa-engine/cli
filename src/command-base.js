...
var CommandBase = /** @class */ (function (_super) {
    ...
    CommandBase.prototype.generate = function (type, generatorOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        env = yeoman_environment_1.createEnv();
                        env.register(require.resolve("./generators/" + type), "oclif:" + type);
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                env.run("oclif:" + type, generatorOptions, function (err, results) {
                                    if (err)
                                        reject(err);
                                    else
                                        resolve(results);
